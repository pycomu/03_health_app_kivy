...
class WikiReaderApp(MDApp):
    ...
    def random_search_button(self):
        ...
        self.root.ids["mdlab"].text = "Search running ..."
    ...
    def get_data(self, *args, title=None):
        ...
        endpoint = f"https://en.wikipedia.org/w/api.php?prop=extracts&explaintext&exintro&format=json&action=query&titles={title.replace(' ', '%20')}"
